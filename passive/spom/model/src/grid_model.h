...
typedef struct {
    ...
    double *fit_m;    /* The fitness matrix */
    ...
    double *work_m;    /* Some working space for computing connectivity */
    double *conn_m;   /* Connectivity matrix */
    ...
    fftw_complex *occ_fft;  /* FFTd occupancy and fitness matrix */
    fftw_complex *ker_fft;  /* FFTd kernel matrix */
    
    /* FFTW plans */
    fftw_plan p_occ_fwd, /* Plan for FFTing the occupancy matrix. */
