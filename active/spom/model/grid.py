...
class Species(object):
    ...
    def __init__(self, phenotype, colonization_rate, extinction_rate, alpha, bell_width, connectivity_iterations = 1):
        ...
        self._iterations = int(connectivity_iterations)
    ...
    def getModelStruct(self):
        ...
        sp = gm.create_species_parameters( self.phenotype, self.colonization_rate, self.extinction_rate, self.alpha, self.fitness_bell_width, self._iterations)
        return sp
